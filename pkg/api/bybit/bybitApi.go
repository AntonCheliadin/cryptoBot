...
func (api *BybitApi) BuyCoinByMarket(coin *domains.Coin, amount float64) (api.OrderDto, error) {
	queryParams := api.buildParams(coin, amount, "Buy")
	return api.orderCoinByMarket(queryParams)
}

func (api *BybitApi) SellCoinByMarket(coin *domains.Coin, amount float64) (api.OrderDto, error) {
	queryParams := api.buildParams(coin, amount, "Sell")
	return api.orderCoinByMarket(queryParams)
}

func (api *BybitApi) orderCoinByMarket(queryParams string) (api.OrderDto, error) {
...
func (api *BybitApi) getOrderDetails(orderResponseDto bybit.OrderResponseDto) (api.OrderDto, error) {
