...
func (s HolderStrategyTradingService) getChangePrice(transactionId int64, currentPrice int64) *domains.PriceChange {
...
func (s HolderStrategyTradingService) saveNewPriceIfNeeded(priceChange *domains.PriceChange, currentPrice int64) {
